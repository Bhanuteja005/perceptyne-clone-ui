...
/**
 * The Perceptyne "P" mark rendered as a faint violet-gradient background shape,
 * inlined 1:1 from the brand asset. Used as the decorative backdrop in the
 * Why-Perceptyne and Footer sections.
 */
export function PerceptyneGlyph({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 262 351"
      fill="none"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#653DBA" stopOpacity="0.2" />
          <stop offset="0.384545" stopColor="#CFB9FF" stopOpacity="0.1" />
          <stop offset="1" stopColor="#653DBA" stopOpacity="0.2" />
        </linearGradient>
        <linearGradient
          id="glyph_stroke"
          x1="0.0677023"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#CFB9FF" stopOpacity="0.15" />
          <stop offset="0.489082" stopColor="#CFB9FF" stopOpacity="0.15" />
          <stop offset="1" stopColor="#CFB9FF" stopOpacity="0.15" />
        </linearGradient>
      </defs>
    </svg>
  );
